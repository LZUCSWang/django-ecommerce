set -gx CONDA_EXE (cygpath "E:/project/miniconda\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "E:/project/miniconda")
set _CONDA_EXE (cygpath "E:/project/miniconda\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "E:/project/miniconda\python.exe")
