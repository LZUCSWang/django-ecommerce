set -gx CONDA_EXE (cygpath "C:\ci\conda_1579892829988\_h_env\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "C:\ci\conda_1579892829988\_h_env")
set _CONDA_EXE (cygpath "C:\ci\conda_1579892829988\_h_env\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "C:\ci\conda_1579892829988\_h_env\python.exe")
